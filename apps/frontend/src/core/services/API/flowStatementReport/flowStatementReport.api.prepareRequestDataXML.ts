...
export const flowStatementReport = (deviceRouting: DeviceRouting): string => {
  const bodyTemplate = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:sir=\"http://sirena-travel.ru\">\n" +
      "  <soapenv:Header />\n" +
      "  <soapenv:Body>\n" +
      ...
      "  </soapenv:Body>\n" +
      "</soapenv:Envelope>\n";
  let body = bodyTemplate.replace("$SERIAL$", deviceRouting.cashRegistersService.cashRegister.serialNumber)
